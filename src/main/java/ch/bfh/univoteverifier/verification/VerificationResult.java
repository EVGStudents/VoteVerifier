...
public class VerificationResult {
     ...
     *
     * @param impl the boolean value representing the implementation for this
     * event.
     */
    ...
    /**
     * Set the entity name for this VerificationResult if any. It can be use to
     * print the name for example of a tallier.
     *
