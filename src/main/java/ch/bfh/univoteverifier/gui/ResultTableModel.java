...
/**
 * This class defines a model for the information that is stored in the tables for the results of verification groups.
 * @author prinstin
 */
public class ResultTableModel extends AbstractTableModel {

    ArrayList<ResultSet> data ;
    String[] columnNames = {"",""};

    /**
     * Create an instance of this ResultTableModel.
     * @param data the data with which to initialize this table.  At least one ResultSet must be present in the list.
     * @param section The description of the section from which this verification result was produced.
     */
    ...
    /**
     * Get the name of the column to be shown in the header of the table. The second column where the image is shown has been left empty.
     ...
     * @param col int value for the column in which to check for editable status.
    ...
    public void addResultPair(ResultSet r) {
       ...
       /**
        * Query for the class type of the objects which are entered into a given column.
