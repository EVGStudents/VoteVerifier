...
public class MainGUI extends JFrame {
	...
	/**
	 * Construct the window and frame of this GUI and initialize certain
	 * base variables.
	 */
	public MainGUI() {
		initResources();
	 ...
	 * method is called when the program starts as well as if a change of
	 * locale is needed. The entire GUI will is recreated.
	 */
