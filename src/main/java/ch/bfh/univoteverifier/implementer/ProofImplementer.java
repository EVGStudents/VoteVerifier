...
public class ProofImplementer extends Implementer {
     ...
     * @param vExponentSign the sign of the exponent for the computation of v,
     * if true the "-" will be used, "+" if false.
     ...
     * @param previousMixerName the name of the previous mixer in order to get
     * the previous generator. Use "schnorr_generator" as name to get the
     * Schnorr public generator.
     *
     * @return a VerificationResult.
     */
    ...
    /**
     * Check the Wikström proof verification keys by the given mixer. WARNING:
     * some plausibility check are performed instead of the proof, which isn't
     * available.
     *
    ...
    /**
     * Verify the NIZKP of the shuffled encrypted votes. WARNING: the proof is
     * not yet implemented, so some plausibility checks will be performed
